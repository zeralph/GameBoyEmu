...
namespace GameBoyTest.Forms.Debug.Visual
{
    public partial class CallstackForm : Form
    {
        ...
        private const String myFormatInst = "{0,-10}{1,-8}{2,-20}{3,-8}{4,-8}{5,-8}{6,-8}{7,-8}{8} {9}";
        private const String myFormatInt = "--INTERRUPT-- {0,-10}{1,-8}{2,-8}";
        ...
        public CallstackForm()
        {
            ...
            m_cnt = 0;
            textLabels.Text = String.Format(myFormatInst, "#", "PC", "inst", "af", "bc", "de", "hl", "SP", "flags", "bank");
        ...
        public void AddToCallstack()
        {
            ...
            //m_contentArray[idx]._length
            //m_contentArray[idx]._bank = GameBoy.Video.getRefreshLine();
            m_contentArray[idx]._bank = GameBoy.Ram.ReadByteAt(0xFF05);
            if (m_bSaveCallStack)
            {
                UpdateContentArray();
            }
